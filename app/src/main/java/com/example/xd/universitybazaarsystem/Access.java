...
public class Access extends Activity {
    ...
    Context context = Access.this;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.club_access);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String emailBody = "A student request join the Access Club.";
                new SendMailTask(Access.this).execute(fromEmail,
    ...
    private void BCLUB()
    {
        new AlertDialog.Builder(context)
                .setTitle("Success!")
                .setMessage("You have successfully Send the Request for join the Access Club !")
